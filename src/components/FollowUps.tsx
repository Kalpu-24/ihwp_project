...
export const FollowUps: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-200 rounded-xl p-6 mb-6">
        <div className="flex items-center gap-3">
          <Bell className="w-8 h-8 text-orange-600" />
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Follow-ups & Reminders</h2>
            <p className="text-orange-700">Stay on track with your wellness journey</p>
          </div>
        </div>
      </div>
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-xl shadow-md p-6 border-l-4 ${
                    overdue ? 'border-red-500' : 'border-orange-500'
                  }`}
                >
                  ...
                  <button
                    ...
                    className="w-full mt-4 flex items-center justify-center gap-2 bg-orange-600 text-white py-2 rounded-lg font-medium hover:bg-orange-700 transition-colors"
                  >

...
export const DietChart: React.FC = () => {
  ...
  const doshaColors: Record<string, { bg: string; text: string; border: string }> = {
    Vata: { bg: 'bg-orange-50', text: 'text-orange-800', border: 'border-orange-200' },
    Pitta: { bg: 'bg-orange-50', text: 'text-orange-800', border: 'border-orange-200' },
    Kapha: { bg: 'bg-orange-50', text: 'text-orange-800', border: 'border-orange-200' },
  };
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="mt-6 bg-orange-50 border border-orange-200 rounded-xl p-6">
        <h3 className="font-semibold text-orange-900 mb-2">General Guidelines</h3>

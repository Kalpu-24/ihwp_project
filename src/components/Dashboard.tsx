...
export const Dashboard: React.FC = () => {
  ...
  const Overview = () => (
    <div className="max-w-4xl mx-auto">
      <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-200 rounded-xl p-8 mb-8">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-orange-50 to-emerald-50">
      <nav className="bg-white shadow-md sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              <Heart className="w-8 h-8 text-orange-600" />
              <span className="text-xl font-bold text-gray-900">Ayurti</span>
            </button>
